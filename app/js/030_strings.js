blockslack.strings = (function(){
    ...
    return {
        ...
        CONTACT_ADDED: "You have added %1 as a contact; any groups they have added you to will appear shortly.",
        COULD_NOT_SEND: "Your message could not be sent, please check that all members of the channel are valid users and if necessary remove any invalid members.",
